...
def apply_style() -> None:
    ...
    st.markdown(
        ...
        .stButton button:not([kind="primary"]), .stDownloadButton button {
            ...
            border: 1px solid #f2d2d8 !important;
            color: var(--cherry-deep) !important;
        }
        .stButton button:not([kind="primary"]) p, .stDownloadButton button p {
            color: var(--cherry-deep) !important;
        }
        ...
        .stButton button:disabled p, .stFormSubmitButton button:disabled p {
            color: #71717a !important;
        }
        label, .stTextInput label, .stTextArea label, .stNumberInput label, .stSelectbox label, .stDateInput label, .stRadio label {
        ...
        @media (max-width: 640px) {
            ...
            .product-desc { min-height: 0; font-size: 14px; }
